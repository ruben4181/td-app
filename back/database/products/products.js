  ...
  return new Promise((resolve, reject) => {
    mysql_util
      ...
      .then((resp) => {
        let conn = resp;
        conn.query(
          sql_constants.SQL_SP_PRODUCTS_GET_BY_STORE,
          [idStore, page, stockAlert],
          (err, resp) => {
            conn.end();
            if (err) {
              resolve({
  ...
  return new Promise((resolve, reject) => {
    mysql_util
      ...
      .then((resp) => {
        let conn = resp;
        conn.query(
          sql_constants.SQL_SP_PRODUCTS_GET_STOCK_ALERT,
          [idStore, page],
          (err, resp) => {
            conn.end();
            if (err) {
  ...
  return new Promise((resolve, reject) => {
    mysql_util
      ...
      .then((resp) => {
        let conn = resp;
        conn.query(
          sql_constants.SQL_SP_PRODUCTS_GET_BY_CATEGORY,
          [idStore, idCategory, page, stockAlert],
          (err, resp) => {
            conn.end();
            if (err) {
              resolve({
...
findProducts = (idStore, query, stockAlert) => {
  return new Promise((resolve, reject) => {
    mysql_util.getConnection().then((resp) => {
      let conn = resp;
      conn.query(
        sql_constants.SQL_SP_PRODUCTS_FIND_PRODUCTS,
        [idStore, query, stockAlert],
        (err, resp) => {
          conn.end();
          if (err) {
            resolve({
...
findProductsByCategory = (idStore, idCategory, query, stockAlert) => {
  return new Promise((resolve, reject) => {
    mysql_util.getConnection().then((resp) => {
      let conn = resp;
      conn.query(
        sql_constants.SQL_SP_PRODUCTS_FIND_PRODUCTS_BY_CATEGORY,
        [idStore, idCategory, query, stockAlert],
        (err, resp) => {
          conn.end();
          if (err) {
            reject({
  ...
  return new Promise((resolve, reject) => {
    mysql_util
      ...
      .then((resp) => {
        let conn = resp;
        conn.query(
          sql_constants.SQL_SP_PRODUCTS_GET_PRODUCT,
          [idProduct],
          (err, result) => {
            conn.end();
            if (err) {
  ...
  return new Promise((resolve, reject) => {
    mysql_util
      ...
      .then((resp) => {
        let conn = resp;
        conn.query(
          sql_constants.SQL_SP_PRODUCTS_GET_ALL_BY_STORE,
          [idStore],
          (err, result) => {
            if (err) {
              resolve({
