...
class CreateCategoryDialog extends React.Component {
  ...
  componentDidMount() {
    Categories.fetchCategoriesParent(this.state.idStore)
      .then((resp) => {
        this.setState({
          parentsOptions: resp,
        });
              ...
              <div className="col-12">
                <div className="form-floating mb-3">
                  <input
                    ...
                    onChange={(e) => {
                      this.updateField("categoryName", e.target.value);
                    }}
                  />
                ...
                <div className="form-floating mb-3">
                  <input
                    ...
                    onChange={(e) => {
                      this.updateField("categoryDescription", e.target.value);
                    }}
                  />
                ...
                <div className="mb-3">
                  ...
                  <Select
                    options={this.state.parentsOptions}
                    onChange={(e) => {
                      this.setState({ parentCategory: e.value });
                    }}
                  />
                  <span className="form-text">
                    Selecciona si la categoria neuva es una subcategoría
                  </span>
                </div>
              </div>
            </div>
  ...
  okButtonClicked(e) {
    ...
    axios(config)
      .then((resp) => {
        ...
        const { categoryName, categoryDescription, parentCategory, idStore } =
          this.state;
        let body = {
          struct: "category",
          data: {
